...
public class BellmanFord {
    ...
    public static double[] bellmanFord(Edge[] edges, int V, int start) {
        ...
        // algorithm to complete. Another stopping condition is when we're unable to relax an
        ...
        // of a negative cycle. A negative cycle has occurred if we can
        // find a better path beyond the optimal solution
        relaxedAnEdge = true;
        for (int v = 0; v < V - 1 && relaxedAnEdge; v++) {
            relaxedAnEdge = false;
            for (Edge edge : edges) {
